const ValidationMessageGenerator = require('./validation-message-generator.js')
...
class UserValidator {
    ...
    async validateAdmin(nickname) {
        ...
        if (user.role !== 'admin') {
            throw new ForbiddenError(`this active dont ${user.role} properties`)
        }
    }
